                       ...
                       <div className="bg-white p-6 rounded-3xl border border-slate-200/60 shadow-sm">
                          ...
                          <ul className="space-y-3">
                             {program.eligibility?.map((item) => (
                               <li key={`eligibility-point-${item.substring(0, 15).replace(/\s+/g, '-')}`} className="flex gap-4 items-start">
                       ...
                       <div className="bg-white p-6 rounded-3xl border border-slate-200/60 shadow-sm">
                          ...
                          <div className="grid grid-cols-1 gap-2">
                             {program.requirements?.map((req) => (
                               <div key={`requirement-check-${req.replace(/\s+/g, '-').toLowerCase()}`} className="flex items-center justify-between p-4 bg-slate-50 rounded-2xl">
